    ...
    groups+: [
      {
        ...
        rules: [
          ...
          },
          {
            ...
            expr: |||
              prometheus_target_scrape_pool_unique_targets_post_config_relabeling{%(prometheusSelector)s} > prometheus_target_scrape_pool_targets_added{%(prometheusSelector)s}
            ||| % $._config,
            'for': '15m',
            labels: {
              severity: 'warning',
